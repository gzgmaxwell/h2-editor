 ...
 * @author villion
 */
import watermarkImg from '../img/wm.png'
// var QRCode;
/* eslint-disable */
(function () {
    ...
    var Drawing = (function () {
        function _onMakeImage() {
            ...
            if (this._htOption.onComplete && this._htOption.onComplete instanceof Function) {
                this._htOption.onComplete(this._elImage.src)
            }
        }
        ...
        var Drawing = function (el, htOption) {
            ...
            el && this._el.appendChild(this._elImage);
        ...
        Drawing.prototype.draw = function (oQRCode) {
            ...
            if (materials.watermark) {
                _oContext.drawImage(materials.watermark, 0, 0, bgWidth, bgHeight)
            }
        ...
        if (vOption) {
            for (var i in vOption) {
                if (vOption[i]) {
                    if (i === 'materials') {
                        let obj = {}
                        for (var j in vOption[i]) {
                            if (vOption[i][j]) {
                                obj[j] = vOption[i][j]
                            }
                        }
                        this._htOption[i] = obj;
                    } else {
    ...
    QRCode.prototype.loadMaterial = function (sText) {
        ...
        for (var i = 0; i < this.materials.length; i++) {
            ...
            if (!src) {
                materialsLoaded.call(this);
            }
            else if (typeof src == 'string') {
                this._htOption.materials[prop] = new Image();
                this._htOption.materials[prop].crossOrigin = 'anonymous'
                ...
                for (var j = 0; j < src.length; j++) {
                    ...
                    this._htOption.materials[prop][j].crossOrigin = 'anonymous'
                ...
                this._htOption.materials[prop] = new Image();
                this._htOption.materials[prop].crossOrigin = 'anonymous'
                this._htOption.materials[prop].src = watermarkImg;
                materialsLoaded.call(this);
            }
