...
export default {
    ...
    computed: {
        ...
        navPanel() {
            return this.$store.state.layout.navPanel
        },
        scale() {
    ...
    methods: {
        ...
        addXLine(e) {
            ...
            if (e.clientX > workspaceRect.left + this.rulerWidth && e.clientX < workspaceRect.right) {
                this.$store.commit('RULER_TOP_ADD', { xLine: { id: 'rule_line_' + Date.now(), left: left / this.eqxPage.scale } })
        ...
        addYLine(e) {
            ...
            if (e.clientY > workspaceRect.top + this.rulerWidth && e.clientY < workspaceRect.bottom) {
                this.$store.commit('RULER_LEFT_ADD', { yLine: { id: 'rule_line_' + Date.now(), top: top / this.eqxPage.scale } })
                this.setConfigHistory()
            }
        },
        setConfigHistory() {
